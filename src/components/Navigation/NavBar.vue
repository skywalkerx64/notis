    ...
    >
      ...
      >
        ...
        <div class="hidden sm:block">
          ...
          <div class="relative">
            <div
              class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4 text-neutral-400"
            >
              <Search :size="20" />
            </div>
            <input
              ...
              id="icon"
              name="icon"
              class="py-2 px-4 ps-11 block w-full bg-neutral-100 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
              placeholder="Search"
            />
          </div>
        </div>
