...
<template>
  <div class="min-h-screen dark:bg-slate-900 lg:grid lg:grid-cols-2">
    <div class="md:h-screen p-32 hidden lg:flex justify-center items-center">
      <img
        class="rounded-xl"
    ...
    <div class="md:h-screen h-screen">
      <div class="dark:bg-slate-900 bg-gray-100 flex h-full items-center py-10">
